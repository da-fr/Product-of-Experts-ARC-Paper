...
neoneye_concept_arc_path = os.path.join('input', 'arc-dataset-collection', 'dataset', 'ConceptARC')
output_path = 'output_evaluate_NemoReArc1200_on_ConceptARC_16x_dfs0.090_with_ttt'
ttt_target_size = 1

# load evaluation dataset
eval_dataset = ArcDataset.load_from_neoneye(neoneye_concept_arc_path)
